...
using namespace pocoro;

pocoro::file::~file()
{}

std::uint64_t pocoro::file::size() const
{
#if POCORO_OS_WINNT
	LARGE_INTEGER size;
...
pocoro::file::file(pocoro::detail::win32::safe_handle&& fileHandle) noexcept
	: m_fileHandle(std::move(fileHandle))
{
}

pocoro::detail::win32::safe_handle pocoro::file::open(
