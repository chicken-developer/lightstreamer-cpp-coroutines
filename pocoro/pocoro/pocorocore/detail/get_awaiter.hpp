...
#ifndef POCORO_GET_AWAITER_HPP
#define POCORO_GET_AWAITER_HPP
...
template<
        typename T,
        std::enable_if_t<pocoro::detail::is_awaiter<T&&>::value, int> = 0>
T&& get_awaiter_impl(T&& value, pocoro::detail::any) noexcept
{
