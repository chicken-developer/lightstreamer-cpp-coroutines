...
#ifndef POCORO_SYNC_WAIT_TASK_HPP
#define POCORO_SYNC_WAIT_TASK_HPP
...
namespace pocoro::detail
{
		...
		template<
			typename AWAITABLE,
			typename RESULT = typename pocoro::awaitable_traits<AWAITABLE&&>::await_result_t,
...
#endif //POCORO_SYNC_WAIT_TASK_HPP
