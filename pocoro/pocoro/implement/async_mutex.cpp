...
#include "../pocorocore/async_mutex.hpp"

#include <cassert>

pocoro::async_mutex::async_mutex() noexcept
	: m_state(not_locked)
	, m_waiters(nullptr)
{}

pocoro::async_mutex::~async_mutex()
{
...
bool pocoro::async_mutex::try_lock() noexcept
{
...
pocoro::async_mutex_lock_operation pocoro::async_mutex::lock_async() noexcept
{
	return async_mutex_lock_operation{ *this };
}

pocoro::async_mutex_scoped_lock_operation pocoro::async_mutex::scoped_lock_async() noexcept
{
	return async_mutex_scoped_lock_operation{ *this };
}

void pocoro::async_mutex::unlock()
{
...
bool pocoro::async_mutex_lock_operation::await_suspend(std::coroutine_handle<> awaiter) noexcept
{
	m_awaiter = awaiter;
