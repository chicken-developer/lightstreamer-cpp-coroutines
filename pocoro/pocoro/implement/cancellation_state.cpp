	...
	namespace detail
	{
		...
		struct cancellation_registration_state
		{
			...
			cancellation_registration_result add_registration(
				pocoro::cancellation_registration* registration);
...
pocoro::detail::cancellation_registration_list_chunk*
pocoro::detail::cancellation_registration_list_chunk::allocate(std::uint32_t entryCount)
{
...
void pocoro::detail::cancellation_registration_list_chunk::free(
	cancellation_registration_list_chunk* chunk) noexcept
{
	std::free(chunk);
}

pocoro::detail::cancellation_registration_list*
pocoro::detail::cancellation_registration_list::allocate()
{
...
void pocoro::detail::cancellation_registration_list::free(cancellation_registration_list* list) noexcept
{
	std::free(list);
}

pocoro::detail::cancellation_registration_state*
pocoro::detail::cancellation_registration_state::allocate()
{
...
void pocoro::detail::cancellation_registration_state::free(cancellation_registration_state* state) noexcept
{
	std::free(state);
}

pocoro::detail::cancellation_registration_result
pocoro::detail::cancellation_registration_state::add_registration(
	pocoro::cancellation_registration* registration)
{
	...
	while (true)
	{
		...
		POCORO_ASSUME(lastChunk != nullptr);
...
pocoro::detail::cancellation_state* pocoro::detail::cancellation_state::create()
{
	return new cancellation_state();
}

pocoro::detail::cancellation_state::~cancellation_state()
{
...
void pocoro::detail::cancellation_state::add_token_ref() noexcept
{
	m_state.fetch_add(cancellation_token_ref_increment, std::memory_order_relaxed);
}

void pocoro::detail::cancellation_state::release_token_ref() noexcept
{
...
void pocoro::detail::cancellation_state::add_source_ref() noexcept
{
	m_state.fetch_add(cancellation_source_ref_increment, std::memory_order_relaxed);
}

void pocoro::detail::cancellation_state::release_source_ref() noexcept
{
...
bool pocoro::detail::cancellation_state::can_be_cancelled() const noexcept
{
	return (m_state.load(std::memory_order_acquire) & can_be_cancelled_mask) != 0;
}

bool pocoro::detail::cancellation_state::is_cancellation_requested() const noexcept
{
	return (m_state.load(std::memory_order_acquire) & cancellation_requested_flag) != 0;
}

bool pocoro::detail::cancellation_state::is_cancellation_notification_complete() const noexcept
{
	return (m_state.load(std::memory_order_acquire) & cancellation_notification_complete_flag) != 0;
}

void pocoro::detail::cancellation_state::request_cancellation()
{
...
bool pocoro::detail::cancellation_state::try_register_callback(
...
void pocoro::detail::cancellation_state::deregister_callback(cancellation_registration* registration) noexcept
{
...
pocoro::detail::cancellation_state::cancellation_state() noexcept
