...
#ifndef POCORO_CANCELLATION_TOKEN_HPP
#define POCORO_CANCELLATION_TOKEN_HPP
...
namespace pocoro
{
    ...
    public:
        ...
        /// Throws pocoro::operation_cancelled exception if cancellation
...
#endif //POCORO_CANCELLATION_TOKEN_HPP
