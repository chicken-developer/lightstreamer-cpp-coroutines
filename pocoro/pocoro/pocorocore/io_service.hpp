...
#ifndef POCORO_IO_SERVICE_HPP
#define POCORO_IO_SERVICE_HPP
...
namespace pocoro
{
    ...
    public:
        ...
        /// immediately.
        /// The co_await operation will throw pocoro::operation_cancelled if
    ...
    private:
        ...
        pocoro::cancellation_token m_cancellationToken;
        std::optional<pocoro::cancellation_registration> m_cancellationRegistration;
...
pocoro::io_service::timed_schedule_operation
pocoro::io_service::schedule_after(
