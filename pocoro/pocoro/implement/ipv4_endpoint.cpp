...
#include "../pocorocore/net/ipv4_endpoint.hpp"
...
std::string pocoro::net::ipv4_endpoint::to_string() const
{
...
std::optional<pocoro::net::ipv4_endpoint>
pocoro::net::ipv4_endpoint::from_string(std::string_view string) noexcept
{
