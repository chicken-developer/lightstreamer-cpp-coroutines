...
bool pocoro::net::socket_connect_operation_impl::try_start(
	pocoro::detail::win32_overlapped_operation_base& operation) noexcept
{
	...
	const int sockaddrNameLength = pocoro::net::detail::ip_endpoint_to_sockaddr(
		m_remoteEndPoint,
...
void pocoro::net::socket_connect_operation_impl::cancel(
	pocoro::detail::win32_overlapped_operation_base& operation) noexcept
{
	(void)::CancelIoEx(
...
void pocoro::net::socket_connect_operation_impl::get_result(
	pocoro::detail::win32_overlapped_operation_base& operation)
{
...

	{
		...
		if (result == 0)
		{
			m_socket.m_localEndPoint = pocoro::net::detail::sockaddr_to_ip_endpoint(
...

	{
		...
		if (result == 0)
		{
			m_socket.m_remoteEndPoint = pocoro::net::detail::sockaddr_to_ip_endpoint(
