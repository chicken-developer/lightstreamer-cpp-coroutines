...
bool pocoro::net::socket_disconnect_operation_impl::try_start(
...
void pocoro::net::socket_disconnect_operation_impl::cancel(
	pocoro::detail::win32_overlapped_operation_base& operation) noexcept
{
	(void)::CancelIoEx(
...
void pocoro::net::socket_disconnect_operation_impl::get_result(
