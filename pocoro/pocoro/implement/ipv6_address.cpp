...
#include "../pocorocore/net/ipv6_address.hpp"
...
std::optional<pocoro::net::ipv6_address>
pocoro::net::ipv6_address::from_string(std::string_view string) noexcept
{
	...
	if (partCount < 8)
	{
		...
		//POCORO_ASSUME(preCount <= partCount);
...
std::string pocoro::net::ipv6_address::to_string() const
{
