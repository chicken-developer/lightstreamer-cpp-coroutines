...
#include "../pocorocore/net/socket_send_to_operation.hpp"
...
bool pocoro::net::socket_send_to_operation_impl::try_start(
...
void pocoro::net::socket_send_to_operation_impl::cancel(
	pocoro::detail::win32_overlapped_operation_base& operation) noexcept
{
	(void)::CancelIoEx(
