...
#include "../pocorocore/net/socket.hpp"

#include "../pocorocore/net/socket_accept_operation.hpp"
#include "../pocorocore/net/socket_connect_operation.hpp"
#include "../pocorocore/net/socket_disconnect_operation.hpp"
#include "../pocorocore/net/socket_recv_operation.hpp"
#include "../pocorocore/net/socket_send_operation.hpp"
...
namespace
{
	namespace local
	{
			...
			HANDLE ioCompletionPort)
		{
			...
			auto closeSocketOnFailure = pocoro::on_scope_failure([&]
			{
...
pocoro::net::socket pocoro::net::socket::create_tcpv4(io_service& ioSvc)
{
...
pocoro::net::socket pocoro::net::socket::create_tcpv6(io_service& ioSvc)
{
	ioSvc.ensure_winsock_initialised();
...
pocoro::net::socket pocoro::net::socket::create_udpv4(io_service& ioSvc)
{
	ioSvc.ensure_winsock_initialised();
...
pocoro::net::socket pocoro::net::socket::create_udpv6(io_service& ioSvc)
{
	ioSvc.ensure_winsock_initialised();
...
pocoro::net::socket::socket(socket&& other) noexcept
...
pocoro::net::socket&
pocoro::net::socket::operator=(socket&& other) noexcept
{
...
void pocoro::net::socket::bind(const ip_endpoint& localEndPoint)
{
	...
	if (result == 0)
	{
		m_localEndPoint = pocoro::net::detail::sockaddr_to_ip_endpoint(*sockaddr);
	}
	else
	{
...
void pocoro::net::socket::listen(std::uint32_t backlog)
{
...
pocoro::net::socket_accept_operation
pocoro::net::socket::accept(socket& acceptingSocket) noexcept
{
	return socket_accept_operation{ *this, acceptingSocket };
}

pocoro::net::socket_accept_operation_cancellable
pocoro::net::socket::accept(socket& acceptingSocket, cancellation_token ct) noexcept
{
	return socket_accept_operation_cancellable{ *this, acceptingSocket, std::move(ct) };
}

pocoro::net::socket_connect_operation
pocoro::net::socket::connect(const ip_endpoint& remoteEndPoint) noexcept
{
	return socket_connect_operation{ *this, remoteEndPoint };
}

pocoro::net::socket_connect_operation_cancellable
pocoro::net::socket::connect(const ip_endpoint& remoteEndPoint, cancellation_token ct) noexcept
{
	return socket_connect_operation_cancellable{ *this, remoteEndPoint, std::move(ct) };
}

pocoro::net::socket_disconnect_operation
pocoro::net::socket::disconnect() noexcept
{
	return socket_disconnect_operation(*this);
}

pocoro::net::socket_disconnect_operation_cancellable
pocoro::net::socket::disconnect(cancellation_token ct) noexcept
{
	return socket_disconnect_operation_cancellable{ *this, std::move(ct) };
}

pocoro::net::socket_send_operation
pocoro::net::socket::send(const void* buffer, std::size_t byteCount) noexcept
{
	return socket_send_operation{ *this, buffer, byteCount };
}

pocoro::net::socket_send_operation_cancellable
pocoro::net::socket::send(const void* buffer, std::size_t byteCount, cancellation_token ct) noexcept
{
	return socket_send_operation_cancellable{ *this, buffer, byteCount, std::move(ct) };
}

pocoro::net::socket_recv_operation
pocoro::net::socket::recv(void* buffer, std::size_t byteCount) noexcept
{
	return socket_recv_operation{ *this, buffer, byteCount };
}

pocoro::net::socket_recv_operation_cancellable
pocoro::net::socket::recv(void* buffer, std::size_t byteCount, cancellation_token ct) noexcept
{
	return socket_recv_operation_cancellable{ *this, buffer, byteCount, std::move(ct) };
}

pocoro::net::socket_recv_from_operation
pocoro::net::socket::recv_from(void* buffer, std::size_t byteCount) noexcept
{
	return socket_recv_from_operation{ *this, buffer, byteCount };
}

pocoro::net::socket_recv_from_operation_cancellable
pocoro::net::socket::recv_from(void* buffer, std::size_t byteCount, cancellation_token ct) noexcept
{
	return socket_recv_from_operation_cancellable{ *this, buffer, byteCount, std::move(ct) };
}

pocoro::net::socket_send_to_operation
pocoro::net::socket::send_to(const ip_endpoint& destination, const void* buffer, std::size_t byteCount) noexcept
{
	return socket_send_to_operation{ *this, destination, buffer, byteCount };
}

pocoro::net::socket_send_to_operation_cancellable
pocoro::net::socket::send_to(const ip_endpoint& destination, const void* buffer, std::size_t byteCount, cancellation_token ct) noexcept
{
	return socket_send_to_operation_cancellable{ *this, destination, buffer, byteCount, std::move(ct) };
}

void pocoro::net::socket::close_send()
{
...
void pocoro::net::socket::close_recv()
{
