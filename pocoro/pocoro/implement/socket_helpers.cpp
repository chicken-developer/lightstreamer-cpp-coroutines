...
#define SCOPEID_UNSPECIFIED_INIT    { 0 } //Windown SDK got err
pocoro::net::ip_endpoint
pocoro::net::detail::sockaddr_to_ip_endpoint(const sockaddr& address) noexcept
{
...
int pocoro::net::detail::ip_endpoint_to_sockaddr(
