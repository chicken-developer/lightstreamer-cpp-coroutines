...
#ifndef POCORO_TASK_HPP
#define POCORO_TASK_HPP
...
namespace pocoro
{
    ...
    namespace detail
    {
...
#else
                // HACK: Need to add POCORO_NOINLINE to await_suspend() method
        ...
        public:
            ...
            // See https://github.com/lewissbaker/pocoro/issues/40#issuecomment-326864107
