...
#include "../pocorocore/io_service.hpp"
#include "../pocorocore/on_scope_exit.hpp"
...
{
#if POCORO_OS_WINNT
	pocoro::detail::win32::safe_handle create_io_completion_port(std::uint32_t concurrencyHint)
	{
		...
		return pocoro::detail::win32::safe_handle{ handle };
	}

	pocoro::detail::win32::safe_handle create_auto_reset_event()
	{
		...
		return pocoro::detail::win32::safe_handle{ eventHandle };
	}

	pocoro::detail::win32::safe_handle create_waitable_timer_event()
	{
...
class pocoro::io_service::timer_queue
{
public:
	...
	void enqueue_timer(pocoro::io_service::timed_schedule_operation* timer) noexcept;

	void dequeue_due_timers(
		time_point currentTime,
		pocoro::io_service::timed_schedule_operation*& timerList) noexcept;
...
private:
	...
	struct timer_entry
	{
		timer_entry(pocoro::io_service::timed_schedule_operation* timer)
			: m_dueTime(timer->m_resumeTime)
			, m_timer(timer)
		{}

		time_point m_dueTime;
		pocoro::io_service::timed_schedule_operation* m_timer;
	};
	...
	pocoro::io_service::timed_schedule_operation* m_overflowTimers;

};

pocoro::io_service::timer_queue::timer_queue() noexcept
	: m_timerEntries()
	, m_overflowTimers(nullptr)
{}

pocoro::io_service::timer_queue::~timer_queue()
{
	assert(is_empty());
}

bool pocoro::io_service::timer_queue::is_empty() const noexcept
{
	return m_timerEntries.empty() && m_overflowTimers == nullptr;
}

pocoro::io_service::timer_queue::time_point
pocoro::io_service::timer_queue::earliest_due_time() const noexcept
{
...
void pocoro::io_service::timer_queue::enqueue_timer(
	pocoro::io_service::timed_schedule_operation* timer) noexcept
{
	try
	{
...
void pocoro::io_service::timer_queue::dequeue_due_timers(
	time_point currentTime,
	pocoro::io_service::timed_schedule_operation*& timerList) noexcept
{
...
void pocoro::io_service::timer_queue::remove_cancelled_timers(
	pocoro::io_service::timed_schedule_operation*& timerList) noexcept
{
...
class pocoro::io_service::timer_thread_state
{
public:
...
pocoro::io_service::io_service()
	: io_service(0)
{
}

pocoro::io_service::io_service(std::uint32_t concurrencyHint)
	: m_threadState(0)
	, m_workCount(0)
#if POCORO_OS_WINNT
...
pocoro::io_service::schedule_operation pocoro::io_service::schedule() noexcept
{
	return schedule_operation{ *this };
}

std::uint64_t pocoro::io_service::process_events()
{
...
std::uint64_t pocoro::io_service::process_pending_events()
{
	std::uint64_t eventCount = 0;
	if (try_enter_event_loop())
	{
...
std::uint64_t pocoro::io_service::process_one_event()
{
	std::uint64_t eventCount = 0;
	if (try_enter_event_loop())
	{
...
std::uint64_t pocoro::io_service::process_one_pending_event()
{
	std::uint64_t eventCount = 0;
	if (try_enter_event_loop())
	{
...
void pocoro::io_service::stop() noexcept
{
...
bool pocoro::io_service::is_stop_requested() const noexcept
{
	return (m_threadState.load(std::memory_order_acquire) & stop_requested_flag) != 0;
}

void pocoro::io_service::notify_work_started() noexcept
{
	m_workCount.fetch_add(1, std::memory_order_relaxed);
}

void pocoro::io_service::notify_work_finished() noexcept
{
...
pocoro::detail::win32::handle_t pocoro::io_service::native_iocp_handle() noexcept
{
...
void pocoro::io_service::ensure_winsock_initialised()
{
...
void pocoro::io_service::schedule_impl(schedule_operation* operation) noexcept
{
#if POCORO_OS_WINNT
...
void pocoro::io_service::try_reschedule_overflow_operations() noexcept
{
#if POCORO_OS_WINNT
...
bool pocoro::io_service::try_enter_event_loop() noexcept
{
...
void pocoro::io_service::exit_event_loop() noexcept
{
	m_threadState.fetch_sub(active_thread_count_increment, std::memory_order_relaxed);
}

bool pocoro::io_service::try_process_one_event(bool waitForEvent)
{
#if POCORO_OS_WINNT
...
void pocoro::io_service::post_wake_up_event() noexcept
{
#if POCORO_OS_WINNT
...
pocoro::io_service::timer_thread_state*
pocoro::io_service::ensure_timer_thread_started()
{
...
pocoro::io_service::timer_thread_state::timer_thread_state()
#if POCORO_OS_WINNT
...
void pocoro::io_service::timer_thread_state::request_timer_cancellation() noexcept
{
...
void pocoro::io_service::timer_thread_state::run() noexcept
{
#if POCORO_OS_WINNT
...
void pocoro::io_service::timer_thread_state::wake_up_timer_thread() noexcept
{
#if POCORO_OS_WINNT
...
void pocoro::io_service::schedule_operation::await_suspend(
...
pocoro::io_service::timed_schedule_operation::timed_schedule_operation(
	io_service& service,
	std::chrono::high_resolution_clock::time_point resumeTime,
	pocoro::cancellation_token cancellationToken) noexcept
...
bool pocoro::io_service::timed_schedule_operation::await_ready() const noexcept
{
	return m_cancellationToken.is_cancellation_requested();
}

void pocoro::io_service::timed_schedule_operation::await_suspend(
...
void pocoro::io_service::timed_schedule_operation::await_resume()
{
