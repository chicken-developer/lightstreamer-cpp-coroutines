...
#include "../pocorocore/net/ipv6_endpoint.hpp"
...
std::string pocoro::net::ipv6_endpoint::to_string() const
{
	std::string result;
	result.push_back('[');
...
std::optional<pocoro::net::ipv6_endpoint>
pocoro::net::ipv6_endpoint::from_string(std::string_view string) noexcept
{
