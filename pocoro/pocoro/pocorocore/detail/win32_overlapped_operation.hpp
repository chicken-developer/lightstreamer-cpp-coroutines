...
#ifndef POCORO_WIN32_OVERLAPPED_OPERATION_HPP
#define POCORO_WIN32_OVERLAPPED_OPERATION_HPP
...
namespace pocoro
{
    namespace detail
    {
        ...
        private:
            ...
            std::optional<pocoro::cancellation_registration> m_cancellationCallback;
            std::coroutine_handle<> m_awaitingCoroutine;
...
#endif //POCORO_WIN32_OVERLAPPED_OPERATION_HPP
