...
#ifndef POCORO_SOCKET_SEND_OPERATION_HPP
#define POCORO_SOCKET_SEND_OPERATION_HPP
...
namespace pocoro::net
{
	...
	class socket_send_operation
		: public pocoro::detail::win32_overlapped_operation<socket_send_operation>
	{
	public:
	...
	private:
		...
		friend class pocoro::detail::win32_overlapped_operation<socket_send_operation>;
	...
	class socket_send_operation_cancellable
		: public pocoro::detail::win32_overlapped_operation_cancellable<socket_send_operation_cancellable>
	{
	public:
		...
		socket_send_operation_cancellable(
			...
			: pocoro::detail::win32_overlapped_operation_cancellable<socket_send_operation_cancellable>(std::move(ct))
			, m_impl(s, buffer, byteCount)
		{}

	private:

		friend class pocoro::detail::win32_overlapped_operation_cancellable<socket_send_operation_cancellable>;
...
#endif //POCORO_SOCKET_SEND_OPERATION_HPP
