...
#include "../pocorocore/net/ipv4_address.hpp"
...
std::optional <pocoro::net::ipv4_address>
pocoro::net::ipv4_address::from_string(std::string_view string) noexcept
{
...
std::string pocoro::net::ipv4_address::to_string() const
{
